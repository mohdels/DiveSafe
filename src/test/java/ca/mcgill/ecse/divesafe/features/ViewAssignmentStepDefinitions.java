...
public class ViewAssignmentStepDefinitions {
  ...
  public void the_following_assignments_exist_in_the_system_p5(
    ...
    for (Map<String, String> assignmentData : cucumberData) {
      ...
      String authCode = String.valueOf(assignmentData.get("authorizationCode"));

      Assignment newAssignment =
          diveSafe.addAssignment(authCode, startDay, endDay, assignmentMember);
  ...
  /**
   * Asserts that the strings are either equal, or one is empty and the other is null, or both are
   * null.
   */
