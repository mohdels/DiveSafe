...
public class DiveSafe
{
  ...
  /* Code from template association_AddManyToOne */
  public Assignment addAssignment(String aAuthorizationCode, int aStartDay, int aEndDay, Member aMember)
  {
    return new Assignment(aAuthorizationCode, aStartDay, aEndDay, aMember, this);
  }
